...
import { getRegras, updateRegra, deleteRegra } from '../lib/db';
        ...
        <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-xl overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">
              <h3 className="font-bold text-slate-800">Editar Regra</h3>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              <div>
                ...
                <input type="text" value={editingRegra.nome} disabled className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-slate-500 text-sm" />
              </div>
