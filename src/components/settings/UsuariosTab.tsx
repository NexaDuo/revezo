...
export function UsuariosTab() {
 ...
 return <div><ConvitesManager /><DataTable<UserProfile> titulo="Usuários" queryKey={['profiles', unidade]} podeCriar={false}
 ...
 columns={[{key:'nome',header:'Nome',searchable:true},{key:'email',header:'E-mail',searchable:true},{key:'role',header:'Papel'},{key:'ativo',header:'Ativo',render:u=>u.ativo?'Sim':'Não'}]}
 ...
 /><p className="p-4 text-xs">Apenas administradores podem promover ou revogar coordenadores.</p></div>;
}
